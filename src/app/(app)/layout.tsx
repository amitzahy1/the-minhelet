    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#F8F9FB] via-white to-[#EEF2FF] flex items-center justify-center overflow-hidden" dir="rtl">
        ...
        <div className="relative flex flex-col items-center">
          ...
          {/* Title */}
          <h1 className="text-5xl sm:text-7xl font-black text-gray-900 tracking-tight mb-2" style={{ fontFamily: "var(--font-secular)" }}>
            THE MINHELET
          </h1>
          ...
          <p className="text-sm text-gray-400 mt-4 font-medium">טוען את הנתונים...</p>
        </div>
