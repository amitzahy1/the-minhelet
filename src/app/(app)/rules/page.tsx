        ...
        <section className="bg-white rounded-2xl border border-gray-200 shadow-md overflow-hidden">
          ...
          <div className="p-5">
            ...
            <div className="mt-5 rounded-xl bg-rose-50 border border-rose-200 px-4 py-3 text-xs text-rose-900 leading-relaxed">
              <p className="font-bold mb-1 text-rose-950">🚫 הימור שאף אחד לא תופס — מתבטל</p>
              <p>
                הימור מיוחד עם תוצאה אחת בלבד וללא ניקוד יחסי (התקפה טובה, בית פורה,
                בית יבש, כסחנית, פנדלים) <strong>מתבטל אם אף אחד לא ניחש נכון</strong> —
                אף מהמר לא מקבל ולא מפסיד נקודות עליו, והוא יסומן בטבלה כ&quot;אף אחד לא
                תופס&quot;. מלך שערים ומלך בישולים לא מתבטלים: גם אם אף אחד לא תפס את המלך,
            ...
            <div className="mt-3 rounded-xl bg-amber-50 border border-amber-200 px-4 py-3 text-xs text-amber-900 leading-relaxed">
              ...
              <p>
                כל עוד התוצאה הסופית לא נרשמה, מלך שערים, מלך בישולים
                <strong> והמאצ׳אפים</strong> מחושבים לפי המצב הנוכחי בטורניר:
                מי שמוביל ברגע נתון (במלך שערים/בישולים — גם מי שניחש את השחקן
                הכי גבוה מבין המהמרים, ובמאצ׳אפ — מי שניחש את השחקן שמוביל כרגע
                בדו-קרב) מקבל את הנקודות באופן זמני (מסומן ב-&quot;⏱ זמני&quot;
                בטבלת הניקוד). הניקוד ייקבע סופית כשמנהל המערכת ירשום את
                התוצאה האמיתית. שובר השוויון בין שחקנים עם אותו מספר שערים:
