                ...
                {!isFinished && !isLive && groupLetter && (() => {
                  ...
                  return (
                    <Link
                      ...
                      className="mt-2.5 w-full inline-flex items-center justify-center gap-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-xs font-bold px-3 py-1.5 shadow-sm transition-colors"
                    >
