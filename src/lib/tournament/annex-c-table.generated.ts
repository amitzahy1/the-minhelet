...
// FIFA World Cup 2026 official Round-of-32 third-place allocation ("Annexe C",
// "Combinations for eight best third-placed teams"): all C(12,8)=495 rows.
//
// Source: FIFA WC2026 Competition Regulations, Annexe C — cross-verified
// cell-by-cell against the Wikipedia template
// (Template:2026_FIFA_World_Cup_third-place_table): 3960/3960 cells agree.
//
// Key   = sorted 8-letter combination of the groups whose 3rd-placed team
//         qualified (best 8 of 12).
// Value = { <winnerSlotGroup>: <groupLetterOfThird> } for the 8 winner slots
//         A,B,D,E,G,I,K,L. Regenerate via scripts (see commit message).
// ============================================================================

export const ANNEX_C_TABLE_GENERATED: Record<string, Record<string, string>> = {
